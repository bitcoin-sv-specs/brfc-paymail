...
- [BRFC Specifications](01-brfc-specifications.md)
  - [Specification Documents](./01-01-specification-documents.md)
  - [BRFC ID Assignment](./01-02-brfc-id-assignment.md)
- [Service Discovery](./02-service-discovery.md)
  - [Host Discovery](./02-01-host-discovery.md)
  - [Capability Discovery](./02-02-capability-discovery.md)
